...
The key principle is that parental stress induces hypermethylation at regulatory restraint genes, particularly NR3C1, FKBP5, and HSD11B2. This does not silence these loci in the traditional sense. Instead repeated glucocorticoid signaling weakens effective feedback regulation and shifts neural systems toward heightened excitatory signaling. Acute cortisol exposure can rapidly enhance excitatory throughput through non genomic glucocorticoid signaling mechanisms that increase presynaptic calcium dynamics, vesicular glutamate release probability, and neuronal excitability. Repeated glucocorticoid exposure then stabilizes this excitatory state through altered transcriptional regulation, increasing NMDA and AMPA receptor expression, altering glutamate handling systems, and heightening membrane excitability. Over repeated stress exposure this configuration becomes the parent’s operating baseline.
