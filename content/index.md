...
In animals the stress methylome forms when cortisol repeatedly activates glucocorticoid receptors inside cells. Each activation cycle moves the cortisol receptor complex into the nucleus, where it reshapes methylation at **NR3C1**, **FKBP5**, and **HSD11B2**. Early work summarized in the systematic review by [(Watkeys et al., 2018)](https://doi.org/10.1016/j.neubiorev.2018.08.017) showed that stress and trauma consistently alter NR3C1 methylation in association with psychopathology and altered transcript expression. The more recent meta analysis by [(Balfour et al., 2025)](https://doi.org/10.1101/2025.10.23.25338702) extends this pattern to acute cortisol responses, showing that stress sensitive methylation states predict endocrine reactivity across studies.  

The intergenerational structure of this process was demonstrated in trauma exposed families where FKBP5 methylation shifts in parents were mirrored in their children, with altered stress sensitivity appearing without direct exposure [(Yehuda et al., 2016)](https://doi.org/10.1016/j.biopsych.2015.08.005). These data establish that stress leaves a methylation trace on glucocorticoid related genes and that this trace can pass between generations.
...
Across plants and animals the stress methylome is therefore a generational record of cumulative excitation. It encodes the experience of one generation into the chromatin architecture of the next and determines excitability, metabolic sensitivity, and antioxidant demand at the beginning of life.
