...
title: Neurosteroids - Structural Control of Sodium and Calcium Flow from the Extracellular Fluid Through NMDA Receptor Pores
tags:
  - Biolectrics
  - Stress
  - Neurosteroids
...
- **24S-hydroxycholesterol** stabilizes a fully open conformation where GluN1a and GluN2B helices bend outward, widening the pore and allowing stronger inward flow of sodium and calcium when the receptor opens [(Kang et al., 2025)](https://doi.org/10.1038/s41586-025-09695-4).  
- **EU1622-240** stabilizes a sub-open state that constrains pore dilation and reduces ionic flow while maintaining signaling [(Kang et al., 2025)](https://doi.org/10.1038/s41586-025-09695-4).  
- **Pregnenolone sulfate** binds the same region in a dual-ligand configuration, creating variable pore geometries and distinct conductance states [(Kang et al., 2025)](https://doi.org/10.1038/s41586-025-09695-4).
