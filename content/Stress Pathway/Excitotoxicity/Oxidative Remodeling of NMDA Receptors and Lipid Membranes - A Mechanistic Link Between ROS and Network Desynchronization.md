...
• [**Volinsky et al. (2011)**](zotero://select/library/items/P77EH9PG) demonstrated that oxidized phosphatidylcholines increase lipid flip-flop, weakening bilayer asymmetry and local electrostatics.  
• [**Ehrenshaft et al. (2015)**](zotero://select/library/items/XCB3ZEAZ) showed ROS attack on tryptophan residues distorts protein geometry and gating domains.  
• [**Mayer & Westbrook (1987)**](zotero://select/library/items/I86MHA5J) characterized the Mg²⁺ block mechanism, which becomes unstable when receptor structure or local charge distribution is altered.  
...
Findings from [**Revisiting Glutamate Excitotoxicity in ALS and Age-Related Neurodegeneration (Frontiers in Neuroscience, 2023)**](zotero://select/library/items/GSN696L4) describe how persistent glutamate signaling drives mitochondrial ROS and lipid peroxidation through phospholipase A₂ activation. 

[**Phospholipase A₂ Activation and Arachidonic Acid Release During Oxidative Stress (Free Radical Biol Med, 2020)**](zotero://select/library/items/UEPD9R5D) further confirms that peroxynitrite generation and lipid breakdown amplify this receptor-level instability.
...
1. [Dushanov E.B. et al., *Effect of Oxidative Stress on the Structure of Glutamate Receptors and Membranes in Neural Cells*, *Phys. Part. Nuclei*, 2025.](zotero://select/library/items/BELUF2CN)   
2. [Volinsky R. et al., *Oxidized Phosphatidylcholines Facilitate Phospholipid Flip-Flop in Liposomes*, *Biophys. J.*, 2011.](zotero://select/library/items/P77EH9PG)   
3. [Ehrenshaft M. et al., *Modification of Protein Tryptophan Residues by Reactive Oxygen Species*, *Free Radic. Biol. Med.*, 2015.](zotero://select/library/items/XCB3ZEAZ)  
4. [Mayer M.L. & Westbrook G.L., *Permeation and Block of NMDA Receptor Channels by Divalent Cations*, *J. Physiol.*, 1987.](zotero://select/library/items/I86MHA5J)   
5. [*Revisiting Glutamate Excitotoxicity in ALS and Age-Related Neurodegeneration*, *Front. Neurosci.*, 2023.](zotero://select/library/items/GSN696L4)  
6. [*Phospholipase A₂ Activation and Arachidonic Acid Release During Oxidative Stress*, *Free Radic. Biol. Med.*, 2020.](zotero://select/library/items/UEPD9R5D) 
