...
chatref: https://chatgpt.com/c/69025abd-5124-832d-b1a7-b0eb766d90ec
...
This creates a positive feedback loop. More receptor expression increases calcium entry, which further activates CREB and perpetuates receptor synthesis. Mitochondrial calcium overload generates reactive oxygen species that damage membranes and DNA. The cell becomes locked in a state of CRE activity dependent excitotoxicity, where receptor upregulation is sustained by firing frequency rather than endocrine regulation [(Heling et al., 2025)](https://doi.org/10.1101/2025.10.28.685035), [(Watkeys et al., 2018)](https://doi.org/10.1016/j.neubiorev.2018.08.017), [(Yehuda et al., 2016)](https://doi.org/10.1016/j.biopsych.2015.08.005), [(Weaver et al., 2004)](https://doi.org/10.1038/nn1276).

---

## Mechanistic Sequence
1. Cortisol entry and GR cycling. Free cortisol diffuses into the cytoplasm, binds GR, and the complex moves to the nucleus to regulate GRE-containing genes that normally reduce excitatory tone.  
2. Prolonged activation. Sustained cortisol exposure traps GR in the nucleus, leads to receptor degradation, and suppresses new synthesis.  
3. Promoter hypermethylation. Chronic stress activates DNA methylation machinery that hypermethylates NR3C1 and reduces GR transcription, a pattern consistently reported across trauma-related cohorts [(Watkeys et al., 2018)](https://doi.org/10.1016/j.neubiorev.2018.08.017), with supportive human and animal evidence [(Yehuda et al., 2016)](https://doi.org/10.1016/j.biopsych.2015.08.005), [(Weaver et al., 2004)](https://doi.org/10.1038/nn1276).  
4. Loss of the cytoplasmic GR pool. With fewer receptors, cortisol can no longer regulate transcription through GREs.  
5. Unopposed CREB–Nur77 activation. In the absence of GR repression, CREB and Nur77 occupy CRE sites on excitatory receptor genes, sustaining NMDA and AMPA subunit transcription [(Heling et al., 2025)](https://doi.org/10.1101/2025.10.28.685035).  
6. Activity-dependent upregulation. Receptor expression becomes driven by neuronal firing and intracellular calcium flux rather than hormonal feedback. Each activation event phosphorylates CREB, perpetuating transcription.  
7. Runaway excitotoxicity. Excess NMDA and AMPA receptors amplify calcium entry, induce mitochondrial ROS, and drive progressive oxidative damage.
...
Conversely, hypomethylation at NR3C1 yields higher GR expression and stronger feedback. This permits rapid shutdown of CREB–Nur77 programs and lowers oxidative stress. Animal and human data indicate that demethylated NR3C1 states are protective and link early-life environment to long-term resilience [(Weaver et al., 2004)](https://doi.org/10.1038/nn1276), [(Yehuda et al., 2016)](https://doi.org/10.1016/j.biopsych.2015.08.005). The broader literature review supports that hypermethylation at NR3C1 is the consistent trauma-associated signal when methodological noise is accounted for [(Watkeys et al., 2018)](https://doi.org/10.1016/j.neubiorev.2018.08.017).

---

## Key Points
- GR restrains Nur77 and shortens stress-induced transcription; loss of GR changes Nur77 DNA-binding dynamics and removes repression [(Heling et al., 2025)](https://doi.org/10.1101/2025.10.28.685035).  
- NR3C1 hypermethylation reduces GR expression and abolishes endocrine feedback across trauma-related conditions [(Watkeys et al., 2018)](https://doi.org/10.1016/j.neubiorev.2018.08.017), with converging evidence from human and animal studies [(Yehuda et al., 2016)](https://doi.org/10.1016/j.biopsych.2015.08.005), [(Weaver et al., 2004)](https://doi.org/10.1038/nn1276).  
...
| [Glucocorticoid receptor gene (NR3C1) DNA methylation in association with trauma, psychopathology, and childhood adversity: A systematic review](https://doi.org/10.1016/j.neubiorev.2018.08.017) | Watkeys et al. | 2018 |
| [Holocaust exposure induced intergenerational effects on FKBP5 methylation and cortisol regulation](https://doi.org/10.1016/j.biopsych.2015.08.005) | Yehuda et al. | 2016 |
