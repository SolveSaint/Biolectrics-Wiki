...
1. **Moderate stress:** ETC leak → O₂•⁻ → H₂O₂ → cardiolipin oxidation → apoptosis.  
2. **Chronic stress:** HO-1 upregulation → Fe²⁺ release → Fenton reaction.  
3. **Antioxidant depletion:** GPX4 and GSH loss → runaway lipid peroxidation.  
4. **Outcome:** Membrane failure → ferroptotic degeneration.
